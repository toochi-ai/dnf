...
class CustomUser(AbstractUser):
    ...
    adres1 = models.CharField(max_length=254, blank=True, null=True)
    adres2 = models.CharField(max_length=254, blank=True, null=True)
    ...
    def clean(self):
        for field in ['company', 'adress1', 'addres2', 'city',
